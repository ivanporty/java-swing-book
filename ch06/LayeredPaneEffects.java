...
// —оздание эффектов дл€ интерфейса 
...
public class LayeredPaneEffects extends JFrame {
  public LayeredPaneEffects() {
    ...
    buttons.add(new JButton("ѕрименить"));
    buttons.add(new JButton("«аписать"));
    buttons.add(new JTextField(20));
    // добавл€ем в панель содержимого
    getContentPane().add(buttons);
    // добавл€ем компонент с анимацией в слой PALETTE
